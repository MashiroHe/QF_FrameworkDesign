 ...
 * purpose: QF框架搭建决定版 整合为 v1.0.0版本-并添加单例到框架中，其它部分与官方v1.0保持不变，并整合官方v1.0.2版本内容 ，
 * 本版本使用教程与QF官方v1.0.2一致，下面只包含框架部分，不包含QFToolKit，QFToolKit也请使用v1.0.2版本
 * 同步更新 v1.0.4  Architecture List为HashSet
 */
